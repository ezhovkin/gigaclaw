---
name: customize
description: Add new capabilities or modify GigaClaw behavior. Use when user wants to add channels (Telegram, Slack, email input), change triggers, add integrations, modify the router, or make any other customizations. This is an interactive skill that asks questions to understand what the user wants.
---

# GigaClaw Customization
...
1. Ask: "Should Telegram use the same @Neo trigger, or a different one?"
2. Ask: "Should Telegram messages create separate conversation contexts, or share with Telegram groups?"
